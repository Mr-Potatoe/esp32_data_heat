...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2024 at 04:50 AM
...
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`admin_id`)  -- Added primary key
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci; -- Changed charset and collation
...
CREATE TABLE `sensor_readings` (
  ...
  `status` ENUM('active', 'inactive') NOT NULL DEFAULT 'active',  -- Changed to ENUM
